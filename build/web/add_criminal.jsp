...
<body>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Add Criminal</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <img class="mr-4 mb-2" src="assets/images/handcuffs.png"
                                                        ...
                                                        <div class=" card-block">
                                                            ...
                                                            <form action="add-criminal-action.jsp" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group row">
                <div class="col-sm-12">
                    <select name="crimeType" class="form-control" style="border-block-color: black;">
                ...
                <div class="col-sm-12">
                    <label class="col-form-label">Crime details:</label>
                </div>
         ...
         <div class="col-sm-6">
            <%
            int numberOfFileInputs = 3; // Set the number of file inputs
