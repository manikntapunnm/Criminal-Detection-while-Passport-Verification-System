                                    ...
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="manage_ps.jsp"> <i class="fa fa-home"></i> </a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="#!">Police Station management</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="#!">Manage Police Station</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <h5>Police Station Management</h5>
                                                        <span></span>
...
%>
        ...
        %>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="station_management.jsp?stationid=<%= resultSet.getString("ps_id")%>">
                                                                                <button
