...
out.println(email);
            ...
            if (!fileName.isEmpty()) {
                updateFields += "image1=?, imagename1=?, ";
          ...
          String sql = "UPDATE applicants SET " + updateFields + " WHERE applicants_id=?";
            updateValues.add(applicantid);
          ...
          try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                if (rowsAffected > 0) {
                    ...
                    out.println("}).then(function() { window.location.href = 'applicants_details.jsp?email=" + email + "'; });");
                    out.println("</script>");
