                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <img class="mr-4" src="assets/images/police-station (1).png"
                                                                height="50px" alt="" style="padding-left:480px">


                                                        </div>
                                                        <h5 style="padding-left:460px">Station Details</h5>
                                                        <div class=" card-block">
                                                            <h4 class="sub-title justify">Details</h4>
...
try {
    ...
    String sql = "SELECT * FROM police_station WHERE ps_id=?";
...
%>
                                                           ...
                                                           <form action="station-management-action.jsp?stationid=<%=stationid%>" method="post" >
                                                                <div class="form-group row">

                                                                    <div class="col-6">
                                                                        <label>Branch Name:</label>
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("branch_name")%>" name="branch">
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label>State:</label>
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("state")%>" name="state">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <label>City:</label>
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("city")%>"name="city">
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label>Locality:</label>
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("locality")%>" name="locality">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("area_code")%>" name="areacode">
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <label>Station Contact:</label>
                                                                        <input type="text" class="form-control"
                                                                            value="<%= resultSet.getString("contact")%>" name="contact">
