                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Passport Management</a>
                                            </li>
...
try {
    ...
    String countSql = "SELECT COUNT(*) AS total FROM applicants ";
    ...
    String sql = "SELECT * FROM applicants ORDER BY applicants_id DESC LIMIT ?, ?";
     ...
     <%
            ...
            while (resultSet.next()) {
                ...
                if (!emailMap.containsKey(email)) {
                    ...
                    byte[] ImageBytes1 = resultSet.getBytes("image1");
                    String ImageBase641 = Base64.encodeBase64String(ImageBytes1);
...
<!--<td>
    <div class="row">
        <div class="col-md-7">  Adjust the column width as needed 
            <form action="add-officerid.jsp" method="post">
            ...
            <input type="hidden" name="applicantid" value="<%= resultSet.getInt("applicants_id")%>">
            <div class="col-sm-1">  Adjust the column width as needed 
                <button type="submit" class="btn btn-primary">Go</button>
                                                                        ...
                                                                        <td>
                                                                            <a href="applicants_details.jsp?email=<%= resultSet.getString("email")%>">
                                                                                <button
