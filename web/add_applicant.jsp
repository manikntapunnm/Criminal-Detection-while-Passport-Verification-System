                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Add Passport</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class=" card-block">
                                                            ...
                                                            <form action="add_applicant-action.jsp" method="post" enctype="multipart/form-data">

                                                                <div class="form-group row">

                                                                    <div class="col-sm-6">
                                                                        <input type="text" name="passport" class="form-control" value="<%= generateUserID() %>"
                                                                            placeholder="Enter Passport Number" readonly>
                                                                    </div>
