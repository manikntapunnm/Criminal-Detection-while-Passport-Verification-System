...
%>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="user_login.jsp" class="nav-item nav-link active">User</a>
    ...
    <div class="container-fluid page-header py-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">User Login</h1>
    ...
    <div class="container-xxl courses ">
        <div class="container">
            <div class="text-center mx-auto mb-5 my-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h6 class="display-6 mb-2">Login Here!</h6>
            </div>
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-7 my-4 mb-0 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-primary text-center p-5">
                        ...
                        <form action="user-login-action.jsp?role=user" method="post">
                            <div class="row">

                                <div class="form-floating">
                                    <input type="text" class="form-control border-0" id="gname"
                                        placeholder="Gurdian Name" name="badge" >
                                    <label for="username_user">Your Id:</label>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="form-floating">
...
<!--                                <a class="btn btn-dark w-100 py-3" href="dashboard.jsp">Login</a>-->
                                 <input type="submit" name="submitUser" class="btn btn-dark w-100 py-3" value="Login as User">
                            </div>
