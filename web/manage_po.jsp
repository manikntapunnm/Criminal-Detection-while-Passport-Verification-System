...
<head>
    <title>Passport Backgroung verification</title>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Manage Police Officer</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <h5>Police Officer Management</h5>
                                                        <span></span>
...
try {
    ...
    String countSql = "SELECT COUNT(*) AS total FROM police_station";
    ...
    String sql = "SELECT * FROM police_station  LIMIT ?, ?";
        ...
        %>
                                                                     ...
                                                                     <tr>
                                                                       ...
                                                                       <td><%= resultSet.getString("branch_name")%></td>
                                                                        ...
                                                                        <td><%= resultSet.getString("area_code")%></td>
                                                                        
                                                                        <td>
                                                                            <a href="officers_list.jsp?branch=<%= resultSet.getString("branch_name")%>">
                                                                                <button
                                                                                    class="btn waves-effect waves-light btn-info btn-outline-info"><i
                                                                                        class="icofont icofont-info-square"></i>view
                                                                                    Officers</button>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
